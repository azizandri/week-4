...
public class MainTutor {
	...
	public static void seedData() {
		...
		matkuls[1] = new MataKuliah("IF100", "Dasar - dasar pemrogramank",3);
		matkuls[2] = new MataKuliah("IF534", "Kecerdasan Buatan",3);
		matkuls[3] = new MataKuliah("CE121", "Aljabar Linear",3);
		matkuls[4] = new MataKuliah("CE441", "Jaringan Koputer",3);
	...
	public static void mainMenu() {
		...
		System.out.println("4. Lihat Mata Kulkiah Kode UM");
	}
